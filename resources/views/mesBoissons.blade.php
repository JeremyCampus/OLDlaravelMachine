    ...
    <table class="greyGridTable">
        ...
        @foreach ($maBoisson as $key)
            <tr>
                ...
                <td><img src="/images/{{$key->code}}.png" alt="{{$key->code}}" style="width:100px;"/></td>
                <td><a href="#" class="btn btn-info"><span class="glyphicon glyphicon-tower"></span> MODIFY</a></td>
                <td><a href="#" class="btn btn-danger"><span class="glyphicon glyphicon-eye-close"></span> DELETE</a></td>
            </tr>
        @endforeach
